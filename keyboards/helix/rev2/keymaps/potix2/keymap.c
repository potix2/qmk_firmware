...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * | Ctrl |   A  |   S  |   D  |   F  |   G  |             |   H  |   J  |   K  |   L  |   ;  |LG(SP)|
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * | Shift|   Z  |   X  |   C  |   V  |   B  |             |   N  |   M  |   ,  |   .  |   /  | Bspc |
   * |------+------+------+------+------+------+-------------+------+------+------+------+------+------|
   * |      |      |      | Alt  | GUI  |Lower |Space |Enter |Raise | Esc  |      |      |      |      |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
      KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,                      KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSLS, \
      KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                      KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, LGUI(KC_SPC) , \
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                      KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_BSPC, \
      _______, _______, _______, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_ENT, RAISE,  KC_ESC,  _______, _______, _______, _______ \
      ),
  ...
  [_RAISE] = LAYOUT( \
      _______, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                   KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, _______, \
      _______, KC_LT,   KC_LBRC, KC_LCBR, KC_LPRN, KC_DQUO,                   KC_GRV,  KC_EQL,  KC_MINS, KC_UNDS, KC_TILD, _______, \
      _______, KC_GT,   KC_RBRC, KC_RCBR, KC_RPRN, KC_QUOT,                   _______, KC_PLUS, KC_BSLS, KC_PIPE, _______, _______, \
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______ \
      ),
